...
from small_dataset_audio.audio.validation import ValidationIssue
...
def compute_summary(
    ...
    Args:
        dataset: The :class:`~small_dataset_audio.data.dataset.Dataset`
            to summarize.
    ...
    if generate_thumbnails and valid_files:
        from small_dataset_audio.audio.thumbnails import (  # noqa: WPS433
