...
def generate(
    ...
    from small_dataset_audio.inference.export import ExportFormat, FORMAT_EXTENSIONS, export_audio
...
def _apply_spatial_post(
    ...
    np.ndarray
        Processed audio.
    """
    from small_dataset_audio.inference.spatial import SpatialMode, apply_spatial
