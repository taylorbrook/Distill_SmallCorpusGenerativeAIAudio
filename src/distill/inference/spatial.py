...
def apply_spatial_to_dual_seed(
    ...
    if config.mode == SpatialMode.STEREO:
        from distill.inference.stereo import create_dual_seed_stereo  # noqa: WPS433
...
def _apply_stereo_with_depth(
    ...
    """
    from distill.inference.stereo import apply_mid_side_widening  # noqa: WPS433
...
def _apply_binaural(
    ...
    from distill.audio.hrtf import load_hrtf, apply_binaural  # noqa: WPS433
