"""``distill ui`` command -- launch the Gradio web UI.

Mirrors the default bare-``distill`` behavior but available explicitly
...
def ui(ctx: typer.Context) -> None:
    ...
    from distill.cli import _cli_state, _launch_gui
