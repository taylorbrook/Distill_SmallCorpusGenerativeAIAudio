...
called on every application launch from :mod:`distill.app`.
...
def run_startup_validation(config: dict, verbose: bool = False) -> bool:
    ...
    Calls :func:`~distill.validation.environment.validate_environment`
    ...
    * **Success** is shown with a green checkmark.
    ...
    from distill.validation.environment import validate_environment
