...
- [x] **GEN-03**: Export pipeline (WAV/MP3/FLAC/OGG), metadata, and spatial audio work unchanged with vocoder output
- [x] **GEN-04**: Griffin-Lim reconstruction code fully removed
...
- [x] **UI-03**: Train tab has "Train Vocoder" option for models with completed VAE training
- [x] **UI-04**: Vocoder training shows loss curve and progress in UI

### CLI

- [x] **CLI-01**: `--vocoder` flag on generate command selects vocoder (auto/bigvgan/hifigan)
- [x] **CLI-02**: `train-vocoder` CLI command trains per-model HiFi-GAN vocoder
